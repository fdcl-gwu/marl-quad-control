...
def create_parser():
    ...
    parser.add_argument('--eval_max_steps', default=5, type=int, help='[sec] Maximum number of steps in each episode for evaluation')
    ...
    parser.add_argument('--lam_M', default=0.5, type=int, metavar='N', help='Magnitude Smoothness (default: 0.2~0.5)')
